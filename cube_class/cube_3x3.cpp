...
#define CUBE_SIZE_3X3 (3)

Cube3x3::Cube3x3() {}
Cube3x3::Cube3x3(Window *window, std::string text, int row, int col)
{
    this->window = window;
    this->text = text;
    this->row = row;
...
void Cube3x3::init(Window *window, std::string text, const char* font_path, int row, int col)
{
    this->window = window;
    this->text = text;
    this->row = row;
...
void Cube3x3::fix_string(std::string fix_text)
{
    text = fix_text;
...
void Cube3x3::draw_cube(void)
{
    ...
    draw_rects(window, &rect, num_moves, CUBE_SIZE_3X3, line_spacing, block_length);
    draw_arrows();
}

// Draw arrow on the cube
void Cube3x3::draw_arrows(void)
{
    ...
    for (int i = 0; i < text.length(); i++)
    {
        ...
        if (i == text.find("U'", i))
        {
            U_PRIME_COMMON(CUBE_SIZE_3X3);
        }
        else if (i == text.find("u'", i))
        {
            arrow_point.x = rect.x + block_length - (block_length/CUBE_SIZE_3X3)/2;
            arrow_point.y = rect.y + 3*(block_length/CUBE_SIZE_3X3)/2;
            make_right_arrow(right_arrow, arrow_point, CUBE_SIZE_3X3, block_length);
            window->draw_lines(right_arrow, SDL_violet, NUM_ARROW_POINTS, 3, 3);

            arrow_point.y = arrow_point.y - (block_length/CUBE_SIZE_3X3);
            make_right_arrow(right_arrow, arrow_point, CUBE_SIZE_3X3, block_length);
            window->draw_lines(right_arrow, SDL_violet, NUM_ARROW_POINTS, 3, 3);
        ...
        {
            U2_COMMON(CUBE_SIZE_3X3);
        }
        else if (i == text.find("u2", i))
        {
            arrow_point.x = rect.x + (block_length/CUBE_SIZE_3X3)/2;
            arrow_point.y = rect.y + 3*(block_length/CUBE_SIZE_3X3)/2;
            make_left_arrow(left_arrow, arrow_point, CUBE_SIZE_3X3, block_length);
        ...
        {
            D_PRIME_COMMON(CUBE_SIZE_3X3);
        }
        else if (i == text.find("d'", i))
        {
            arrow_point.x = rect.x + (block_length/CUBE_SIZE_3X3)/2;
            arrow_point.y = rect.y + block_length - 3*(block_length/CUBE_SIZE_3X3)/2;
            make_left_arrow(left_arrow, arrow_point, CUBE_SIZE_3X3, block_length);
            window->draw_lines(left_arrow, SDL_violet, NUM_ARROW_POINTS, 3, 3);
        ...
        {
            L_PRIME_COMMON(CUBE_SIZE_3X3);
        }
        else if (i == text.find("l'", i))
        {
            arrow_point.x = rect.x + 3*(block_length/CUBE_SIZE_3X3)/2;
            arrow_point.y = rect.y + (block_length/CUBE_SIZE_3X3)/2;
            make_up_arrow(up_arrow, arrow_point, CUBE_SIZE_3X3, block_length);
            window->draw_lines(up_arrow, SDL_violet, NUM_ARROW_POINTS, 3, 3);

            arrow_point.x = arrow_point.x - block_length/CUBE_SIZE_3X3;
            make_up_arrow(up_arrow, arrow_point, CUBE_SIZE_3X3, block_length);
            window->draw_lines(up_arrow, SDL_violet, NUM_ARROW_POINTS, 3, 3);
        ...
        {
            L_COMMON(CUBE_SIZE_3X3);
        }
        else if (i == text.find("l", i))
        {
            arrow_point.x = rect.x + 3*(block_length/CUBE_SIZE_3X3)/2;
            arrow_point.y = rect.y + block_length - (block_length/CUBE_SIZE_3X3)/2;
            make_down_arrow(down_arrow, arrow_point, CUBE_SIZE_3X3, block_length);
        ...
        {
            R_PRIME_COMMON(CUBE_SIZE_3X3);
        }
        else if (i == text.find("r'", i))
        {
            arrow_point.x = rect.x + block_length - 3*(block_length/CUBE_SIZE_3X3)/2;
            arrow_point.y = rect.y + block_length - (block_length/CUBE_SIZE_3X3)/2;
            make_down_arrow(down_arrow, arrow_point, CUBE_SIZE_3X3, block_length);
            window->draw_lines(down_arrow, SDL_violet, NUM_ARROW_POINTS, 3, 3);
        ...
        else if (i == text.find("f'", i))
        {
            ...
            make_circle_arrows(right_arrow, // TODO: do you even need this
                                down_arrow,
                                left_arrow,
                                up_arrow,
                                &radius,
        ...
        {
            X_PRIME_COMMON(CUBE_SIZE_3X3);
        }
        else if (i == text.find("x2", i))
        {
            X2_COMMON(CUBE_SIZE_3X3);
        }
        else if (i == text.find("x", i))
        {
            X_COMMON(CUBE_SIZE_3X3);
        }
        
        // y moves
        else if (i == text.find("y'", i))
        {
            Y_PRIME_COMMON(CUBE_SIZE_3X3);
        }
        else if (i == text.find("y2", i))
        {
            Y2_COMMON(CUBE_SIZE_3X3);
        }
        else if (i == text.find("y", i))
        {
            Y_COMMON(CUBE_SIZE_3X3);
        }
        
        // z moves
        else if (i == text.find("z'", i))
        {
            Z_PRIME_COMMON(CUBE_SIZE_3X3);
        }
        else if (i == text.find("z2", i))
        {
            Z2_COMMON(CUBE_SIZE_3X3);
        }
        else if (i == text.find("z", i))
        {
            Z_COMMON(CUBE_SIZE_3X3);
        }

        // Slice moves
        else if (i == text.find("M'", i))
        {
            M_PRIME_COMMON(CUBE_SIZE_3X3);
        }
        else if (i == text.find("M2", i))
        {
            M2_COMMON(CUBE_SIZE_3X3);
        }
        else if (i == text.find("M", i))
        {
            M_COMMON(CUBE_SIZE_3X3);
        }
        else if (i == text.find("E'", i))
        {
            E_PRIME_COMMON(CUBE_SIZE_3X3);
        }
        else if (i == text.find("E2", i))
        {
            E2_COMMON(CUBE_SIZE_3X3);
        }
        else if (i == text.find("E", i))
        {
            E_COMMON(CUBE_SIZE_3X3);
        }
        else if (i == text.find("S'", i))
        {
            S_PRIME_COMMON(CUBE_SIZE_3X3);
        }
        else if (i == text.find("S2", i))
        {
            S2_COMMON(CUBE_SIZE_3X3);
        }
        else if (i == text.find("S", i))
        {
            S_COMMON(CUBE_SIZE_3X3);
        }
