...
class cube {
    public:
        ...
        void init(std::string text) {
            ...
            b2Texture.init(window.renderer,           fontPath, "B2",   fontSize - 10);
